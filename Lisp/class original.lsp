;class.lsp file provided by Dr. Rimes
;Defvar added for sbcl compatibility
;name changed from class to classes for sbcl compatibility

(defvar classes)
(setq classes '((name Seymore) (eng 3 4.0) (mat 3 3.0) (his 3 4.0) (bio 3 2.0) (biol 1 4.0))
